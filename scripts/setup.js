...
$(document).ready(function () {
    ...
    var $container = $('div#recommend div#works').isotope({
        itemSelector: 'img.work',
        layoutMode: 'fitRows'
    });

    // items filter
    $('div#recommend #works_filter a').click(function () {
        var selector = $(this).attr('data-filter');
        $('div#recommend div#works').isotope({
            filter: selector,
            itemSelector: 'img.work',
            layoutMode: 'fitRows'
        });

        $('div#recommend #works_filter').find('a.selected').removeClass('selected');
        $(this).addClass('selected');

        return false;
    });
	
	var $container = $('div#rank div#works').isotope({
        itemSelector: 'div.work',
        layoutMode: 'fitRows'
    });
	$('div#rank div#works').isotope({ filter: '.rege' });
    // items filter
    $('div#rank #works_filter a').click(function () {
        var selector = $(this).attr('data-filter');
        $('div#rank div#works').isotope({
            filter: selector,
            itemSelector: 'div.work',
            layoutMode: 'fitRows'
        });

        $('div#rank #works_filter').find('a.selected').removeClass('selected');
        $(this).addClass('selected');

        return false;
    });
	
	var $container = $('div#music div#works').isotope({
        itemSelector: 'img.work',
        layoutMode: 'fitRows'
    });

    // items filter
    $('div#music #works_filter a').click(function () {
        var selector = $(this).attr('data-filter');
        $('div#music div#works').isotope({
            filter: selector,
            itemSelector: 'img.work',
            layoutMode: 'fitRows'
        });

        $('div#music #works_filter').find('a.selected').removeClass('selected');
        $(this).addClass('selected');

        return false;
    });
	
	var $container = $('div#my div#works').isotope({
        itemSelector: 'img.work',
        layoutMode: 'fitRows'
    });

    // items filter
    $('div#my #works_filter a').click(function () {
        var selector = $(this).attr('data-filter');
        $('div#my div#works').isotope({
            filter: selector,
            itemSelector: 'img.work',
            layoutMode: 'fitRows'
        });

        $('div#my #works_filter').find('a.selected').removeClass('selected');
        $(this).addClass('selected');
